...
type ReputationConfig struct {
	...
	EvictAfter   time.Duration  `json:"-"` // populated from EvictAfterDays
...
// the set of distinct source IPs that have hit it so botnet-style
// distributed abuse becomes visible.
